  ...
  return (
    <div className='w-full h-screen flex justify-center items-center'>
      <form onSubmit={handleSubmit(data=>console.log(data))} className='w-60 h-52 items-center p-4 border border-zinc-400' action="" >
        <input {...register('name')} className='m-3 border border-zinc-400' type="text" placeholder='Name' />
        <input {...register('email')} className='m-3 border border-zinc-400' type="email" placeholder='email' />
        <div>
